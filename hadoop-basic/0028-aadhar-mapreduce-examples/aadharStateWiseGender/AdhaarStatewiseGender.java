...
public class AdhaarStatewiseGender
{
	...
	public static void main(String[] args) throws Exception 
	{
    		...
    		job.setJarByClass(AdhaarStatewiseGender.class);
		...
		// hadoop fs -mkdir /tmp/hadoop_jobs/aadhar_data
		//	hadoop fs -put adhaar_data.csv /tmp/hadoop_jobs/aadhar_data
		
		
    		FileInputFormat.addInputPath(job, new Path("/tmp/hadoop_jobs/aadhar_data/adhaar_data.csv"));
    		FileOutputFormat.setOutputPath(job, new Path("/tmp/hadoop_jobs/temp_output1"));
